        ...
        return (
            ...
            >
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        busRoutesList.map((item) => (
                            ...
                            >
                                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                    <Text style={{ width: 60.0, ...item.isArrive ? { ...Fonts.lightGrayColor14Regular } : { ...Fonts.blackColor14Regular } }}>
                                        {item.time}
                                    </Text>
                                    ...
                                    <Text numberOfLines={2} style={{ marginRight: Sizes.fixPadding - 7.0, flex: 1, ...item.isArrive ? { ...Fonts.lightGrayColor14Regular } : { ...Fonts.blackColor14Regular } }}>
                                        {item.route}
                                    </Text>
                                </View>
                    ...
                    <TouchableOpacity
                        activeOpacity={0.9}
                        onPress={() => { navigation.push('EndTrip') }}
